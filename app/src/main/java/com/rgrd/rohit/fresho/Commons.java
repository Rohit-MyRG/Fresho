...
public class Commons {
    ...
    public ArrayList<Category_Items_POJO> getPersonalCare() {
        ...
        category_items_pojo1.setCategoryName("Personal Care");
        category_items_pojo1.setItemCatName("Shampoo");
        category_items_pojo1.setItemImage("https://firebasestorage.googleapis.com/v0/b/fresho-a1092.appspot.com/o/productImages%2FDove%20Intense%20Repair%20Shampoo.png?alt=media&token=2a1b6134-ed7b-4164-b381-7f3858c9d018");
        category_items_pojo1.setItemMRPStrikePrice("810");
        category_items_pojo1.setItemName("Dove Intense Repair Shampoo");
        category_items_pojo1.setItemPrice(494);
        category_items_pojo1.setItemWeight("650 ml");
    ...
    public ArrayList<Category_Items_POJO> getSearchData() {
        ...
        Category_Items_POJO category_items_pojo18 = new Category_Items_POJO();
        category_items_pojo18.setButtonItemCount(0);
        category_items_pojo18.setCategoryName("Personal Care");
        category_items_pojo18.setItemCatName("Shampoo");
        category_items_pojo18.setItemImage("https://firebasestorage.googleapis.com/v0/b/fresho-a1092.appspot.com/o/productImages%2FDove%20Intense%20Repair%20Shampoo.png?alt=media&token=2a1b6134-ed7b-4164-b381-7f3858c9d018");
        category_items_pojo18.setItemMRPStrikePrice("810");
        category_items_pojo18.setItemName("Dove Intense Repair Shampoo");
        category_items_pojo18.setItemPrice(494);
        category_items_pojo18.setSearchItemName("Shampoo");
        category_items_pojo18.setItemWeight("650 ml");

        itemDetailList.add(category_items_pojo18);

        Category_Items_POJO category_items_pojo19 = new Category_Items_POJO();
        category_items_pojo18.setButtonItemCount(0);
        category_items_pojo18.setCategoryName("Personal Care");
        category_items_pojo18.setItemCatName("Shampoo");
        category_items_pojo18.setItemImage("https://firebasestorage.googleapis.com/v0/b/fresho-a1092.appspot.com/o/productImages%2FDove%20Intense%20Repair%20Shampoo.png?alt=media&token=2a1b6134-ed7b-4164-b381-7f3858c9d018");

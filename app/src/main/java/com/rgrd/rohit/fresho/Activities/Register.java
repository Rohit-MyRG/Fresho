package com.rgrd.rohit.fresho.Activities;
...
import com.rgrd.rohit.fresho.Commons;
import com.rgrd.rohit.fresho.ItemsPOJO.Categories_POJO;
...
import com.rgrd.rohit.fresho.HelperClass.SelectImageHelper;
import com.rgrd.rohit.fresho.POJO_Class.MyPojo;
import com.rgrd.rohit.fresho.R;
import com.rgrd.rohit.fresho.databinding.ActivityRegisterBinding;
...
//        ArrayList<Category_Items_POJO> personalCareList = new Commons().getPersonalCare();
//        for (int j = 0; j < personalCareList.size(); j++) {
//            databaseReference.child(myPojo.getMobile()).child("items").child(personalCareList.get(j).getCategoryName()).child(personalCareList.get(j).getItemName()).setValue(personalCareList.get(j));
//        }
    }
...
//        ArrayList<Category_Items_POJO> personalCareList = new Commons().getPersonalCare();
//        for (int j = 0; j < personalCareList.size(); j++) {
//            databaseReference.child(myPojo.getMobile()).child("products").child(personalCareList.get(j).getCategoryName()).child(personalCareList.get(j).getItemCatName()).child(personalCareList.get(j).getItemName()).setValue(personalCareList.get(j));
//        }
    }
}
